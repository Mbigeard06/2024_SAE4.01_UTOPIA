...
INSERT INTO `blogs` (`idBlog`, `title`, `image`, `creator`, `date`, `votes`, `content`) VALUES
...
--
-- Structure de la table `blogvotes`
--
...
INSERT INTO `events` (`idEvent`, `event_by`, `title`, `date_created`, `event_date`, `event_image`, `headline`, `description`) VALUES
...
INSERT INTO `messages` (`idMessage`, `user_from`, `user_to`, `message`) VALUES
(2, 24, 30, 'mmm'),
(3, 30, 24, 'hello'),
(4, 24, 30, 'aaa'),
(5, 24, 30, 'hello there'),
(6, 24, 30, 'a'),
(7, 24, 25, 'hey there buddy'),
(8, 24, 25, 'how ya doing?'),
(9, 25, 24, 'doing fine bro'),
(10, 25, 24, 'why havent you died yet'),
(11, 24, 25, 'dasd as das das das'),
(12, 25, 24, 'das das das'),
(13, 24, 25, 'fuck off'),
(14, 25, 24, 'you too ;}'),
(15, 25, 24, ':]'),
(16, 24, 25, 'dont be aa burden'),
(17, 25, 24, ':)'),
(18, 25, 24, 'no'),
(19, 25, 24, 'be your own burden'),
(20, 24, 25, 'yea i make my ownn burden'),
(21, 25, 24, 'being bese-8b be like'),
(22, 24, 25, 'aa'),
(23, 25, 24, 'Hey there!'),
(24, 24, 25, 'fuck off'),
(25, 25, 24, 'ok, bye'),
(26, 25, 24, 'You told me to fuck off, so I\\\'m going now'),
(27, 24, 25, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'),
(28, 25, 24, 'aaaaaaaaaaaaaaaaaaaaaaaaaaa'),
(29, 24, 25, 'aaaaaaaaaaaaaaaaa'),
(30, 25, 24, 'aaaaaaaaaaaaaaaa'),
(31, 25, 24, 'hhhh'),
(32, 25, 24, 'f off raveed'),
(33, 24, 25, 'aaaaaaaaaaaaaaa'),
(34, 24, 25, 'a'),
(35, 24, 25, 'a'),
(36, 24, 25, 'a'),
(37, 25, 24, 'a'),
(38, 25, 24, 'a'),
(39, 24, 25, 'sasas'),
(40, 24, 25, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'),
(41, 24, 25, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'),
(42, 24, 25, 'dsadas dsa'),
(43, 24, 25, 'get lost'),
(44, 24, 25, 'sdasd dssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss'),
(45, 24, 25, 'sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss'),
(46, 24, 25, 'asdasdasd'),
(47, 24, 25, 'asdasdasd'),
(48, 24, 25, 'hey'),
(49, 24, 31, 'hello?'),
(50, 24, 25, 'oye'),
(51, 24, 25, 'hello'),
(52, 37, 24, 'wassup ma nigga'),
(53, 37, 35, 'fuck u'),
(54, 37, 35, 'fuck u'),
(55, 24, 37, 'fuck you'),
(56, 36, 24, 'soora'),
(57, 24, 36, 'dalla'),
(58, 35, 37, 'Please don\\\'t send offending messages'),
(59, 35, 24, 'Hi there!'),
(60, 35, 24, 'You ready for the presentation?'),
(61, 24, 35, 'hello'),
(62, 38, 35, 'hello'),
(63, 35, 38, 'heyyy'),
(64, 35, 38, 'heyyy'),
...
(66, 35, 38, 'heyyy'),
(67, 24, 36, 'oye'),
(68, 24, 36, 'i have something important to tell you'),
(69, 24, 36, 'i have something important to tell you'),
(70, 24, 38, 'hey'),
(71, 24, 38, 'hello?'),
(72, 39, 35, 'hello'),
(73, 24, 35, 'nah man, im too nervous'),
(100, 24, 40, 'Bonjour');
...
--
-- Structure de la table `postvotes`
--
...
ALTER TABLE `blogs`
  ...
  ADD KEY `blog_by` (`creator`);

--
-- Index pour la table `blogvotes`
--
...
ALTER TABLE `poll_options`
  ADD PRIMARY KEY (`idPolloptions`),
  ADD KEY `poll_options_ibfk_1` (`poll_id`);
...
ALTER TABLE `poll_votes`
  ...
  ADD KEY `poll_votes_ibfk_1` (`poll_id`),
  ADD KEY `poll_votes_ibfk_2` (`poll_option_id`),
  ADD KEY `poll_votes_ibfk_3` (`vote_by`);
...
--
-- Index pour la table `postvotes`
--
ALTER TABLE `postvotes`
  ADD PRIMARY KEY (`idPostvotes`),
  ADD KEY `voteBy` (`voteBy`);
...
--
-- AUTO_INCREMENT pour la table `blogvotes`
--
ALTER TABLE `blogvotes`
...
--
ALTER TABLE `polls`
  MODIFY `idPoll` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT pour la table `poll_options`
--
ALTER TABLE `poll_options`
  MODIFY `idPolloptions` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `poll_options`
  ADD CONSTRAINT `poll_options_ibfk_1` FOREIGN KEY (`poll_id`) REFERENCES `polls` (`idPoll`) ON DELETE CASCADE;
